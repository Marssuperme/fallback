package cn.org.gdicpa.web.action.bbqtssjjb;
...
public class QtssjjbAction extends MultiActionController{
	private static String LIST = "/bbqtssjjb/list.jsp";
	private static String ADDANDEDIT = "/bbqtssjjb/addAndEdit.jsp";
	private static String SEARCH = "/bbqtssjjb/search.jsp";
...
//			userMap.put("area", clt.getArea());//事务所归属地
	 ...
	 * @throws IOException 
	 */
	public ModelAndView deleteQtssjjbTable(HttpServletRequest request,HttpServletResponse response) throws IOException{
		Connection conn = null;
		String typeid = request.getParameter("typeid");
		try {
			conn = new DBConnect().getConnect();
		...
		response.sendRedirect("bbqtssjjb.do?method=index&typeid="+typeid);
		return null;
	}
