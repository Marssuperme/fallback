package cn.org.gdicpa.web.action.bbsdshsqj;
...
public class SdshsqjbAction extends MultiActionController{
	private static String LIST = "/bbsdshsqjb/list.jsp";
	private static String ADDANDEDIT = "/bbsdshsqjb/addAndEdit.jsp";
	private static String SEARCH = "/bbsdshsqjb/search.jsp";
...
//			userMap.put("area", clt.getArea());//事务所归属地
	 ...
	 * @throws IOException 
	 */
	public ModelAndView deleteSdshsqjTable(HttpServletRequest request,HttpServletResponse response) throws IOException{
		Connection conn = null;
		String typeid = request.getParameter("typeid");
		try {
			conn = new DBConnect().getConnect();
		...
		response.sendRedirect("bbsdshsqjb.do?method=index&typeid="+typeid);
		return null;
	}
