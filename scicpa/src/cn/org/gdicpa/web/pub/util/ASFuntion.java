...
public class ASFuntion {
	...
	public String dealData(String n, String s, String value) {
		...
		if (n.indexOf("showMoney1") != -1) {
			...
			s = "<td style=\"\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"> "
					+ s + "</td>";
		}
	...
	public String showHidden(String s) {
		return "<td  style=\"display:none\">" + s + "</td>";
	}
	
	public String showWidth(String s, String v) {
		return "<td  id=\"widthTD" + v + "\" nowarp width=\"100\" >" + s + "</td>";
	}
	...
	public String showAnalyze(String s, String v) {
		...
		if (values.length >= 3) {
			return "<td  id=\"analyzeTD"
					+ v
					+ "\" align=\"center\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"><a href='javascript:goAnalyze(\""
	...
	public String showRectify(String s, String v) {
		String APPTYPE = cn.org.gdicpa.web.pub.sys.UTILSysProperty.SysProperty
				.getProperty("APPTYPE");
		if ("1".equals(APPTYPE)) {
			...
			return "<td  id=\"rectifyTD"
					+ v
					+ "\" align=\"center\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"><a href='javascript:goRectify("
					+ v + ");'>调</a></td>";
		}
		...
		if ("1".equals(APPTYPE)) {
			...
			if (s.equals("")) {
				return ("<td  id=\"TaskTaxTD"
						+ v
						+ "\" align=\"center\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"><span onmouseover=\"autoDisplay(this,"+v+");\" onmouseout=\"autoHidden();\"><a href='javascript:taskTax("
						+ v + ");'>税</a></span></td>");
			} else if ("0".equals(s)) {
				return "<td></td>";
			} else {
				...
				return ("<td id=\"TaskTaxTD"
						+ v
						+ "\" align=\"center\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"><span onmouseover=\"autoDisplay(this,"+v+");\" onmouseout=\"autoHidden();\"><a id=\"outT"
						+ v + "\" href='javascript:taskTax(" + v + ");'><font color=\"red\">税</font></a>&nbsp;|&nbsp;<a id=\"outT"+ v + "\" href='javascript:taskEdit(" + v + ");'><font color=\"red\">改</font></a></span></td>");
	...
	public String showEliminate(String s, String v) {
		...
		if ("1".equals(APPTYPE)) {
			...
			s = showNull(s);
			if (s.equals("")) {
				return ("<td  id=\"EliminateTD" + v
						+ "\" align=\"center\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"><a href='javascript:eliminate("
						+ v + ");'>剔</a></td>");
			} else if ("0".equals(s)) {
				return "<td></td>";
			} else {
				// return ("<td></td>");
				return ("<td id=\"EliminateTD" + v
						+ "\" align=\"center\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"><a id=\"outT" + v
						+ "\" href='javascript:eliminate(" + v + ");'><font color=\"red\">撤</font></a></td>");
	...
	public String showDoubt(String s, String v) {
		s = showNull(s);
		if (s.equals("")) {
			return ("<td  id=\"doubtTD"
					+ v
					+ "\" align=\"center\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"> "
			...
			return ("<td id=\"doubtTD"
					+ v
					+ "\" align=\"center\"  onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"> "
					+ "<a id=\"outA" + v + "\" href='javascript:takeDoubt("
					+ v + ");'><font color=\"red\">撤</font></a></td>");
	...
	public String showTakeOut(String s, String v) {
		...
		if (s.equals("")) {
			return ("<td id=\"outTD" + v + "\" align=\"center\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"><a id=\"outA"
			...
			return ("<td id=\"outTD"
					+ v
					+ "\" align=\"center\"  onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"><a id=\"outA"
	...
	public String showCarry(String s,String v){
		...
		if (s.equals("")) {
			return ("<td id=\"carryTD" + v + "\" align=\"center\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\">" +
					"<a id=\"outC"+ v + "\" href='javascript:takeCarry(" + v + ");' " + ">结</a></td>");
		} else if ("0".equals(s)) {
			return "<td></td>";
		} else {
			return ("<td id=\"carryTD"+ v+ "\" align=\"center\"  onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\">" +
	...
	public String showMoney(String s) {
		...
		if (!s.equals("")) {
			...
			if ("是".equals(UTILSysProperty.SysProperty.get("零值不显示")) && Math.abs(d)<0.005){
				s= " ";
			}else{
			...
			if (s.trim().indexOf("-") == 0) {
				return ("<td style=\"text-align:right;color:#FF0000\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\" nowrap>"
						+ s + "</td>");

			} else {
				return ("<td style=\"text-align:right;color:#0000FF\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\" nowrap>"
						+ s + "</td>");
			}
		} else {
	...
	public String showProportion(String number) {
		...
		if (value < 0) {
			return ("<td style=\"text-align:right;color:#FF0000\" nowrap onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\">"
					+ formatter.format(value) + "%</td>");

		} else {
			return ("<td style=\"text-align:right;color:#0000FF\" nowrap onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\">"
					+ formatter.format(value) + "%</td>");
		}
	}
	...
	public String maxLen(String s, String format) {
		...
		return "<td style=\"width:"
				+ len
				+ "\" onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\"> "
				+ s + "</td>";
	}

	public String showDate(String s, String format) {
		if (s == null || "".equals(s)) {
			return "<td style=\"\" nowarp onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\">" + s + "</td>";
		}
		...
		try {
			java.util.Date d = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
					.parse(s);
			return "<td style=\"\" nowarp onselectstart=\"return false\" onmousemove=\"return selectMultiCell(event);\" onmousedown=\"return selectCell(event)\">"
