...
public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
{
		...
		.getAttribute("userSession");
	   	 String nameString=hrequest.getServerName();
	     String referer=hrequest.getHeader("referer");
	     //System.out.println("refere=="+referer);
	     referer=StringUtil.showNull(referer);
	     if(userSession!=null&&!referer.contains(nameString)&&!referer.equals("")){
	    	 hrequest.getSession().removeAttribute("userSession");
