	   ...
	   <div class="gridFrame">	 
	    <div style="margin-bottom: 0.5%">
		    ...
		    <fieldset  style="border: 1px solid lightblue;width:95%;height: 70%;margin-left: 2px;" id="fieldset">
				...
				<table>
		    		<tr>
		    			<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;会员名称：&nbsp;&nbsp;&nbsp;&nbsp;<input id="notemastername" name="notemastername"></td>
		    		</tr>
		    		<tr>
		    			<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;文&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：&nbsp;&nbsp;&nbsp;&nbsp;<input id="fieldNumber" name="fieldNumber"></td>
		    		</tr>
		    		<tr>
		    			<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;日&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;期：&nbsp;&nbsp;&nbsp;&nbsp;<input id="recordDate1" name="recordDate1" showcalendar="true"></td>
		    		</tr>
		    		<tr>
		    			<td colspan="1" style="width: 24%">&nbsp;</td>
		    			<td>&nbsp;&nbsp;&nbsp;至<input id="recordDate2" name="recordDate2" showcalendar="true"></td>
		    		</tr>
		    	</table>
		    	<br>
	    ...
	    <div style="width:100%;overflow:auto;height:100%;"> 
	    	<mt:DataGridPrintByBean name="tradePrizeRecord"/>
	    </div>
		</div>
</body>
...
<script type="text/javascript">
	...
	// 查看详细
	function f_view(){
		var chooseValue = document.getElementById('chooseValue_tradePrizeRecord').value ;
		if(chooseValue==null || chooseValue==""){
			alert("请选择要查看的记录");
		}else{
			myform.action = "${pageContext.request.contextPath}/common/tradePrizeRecord.do?method=view&id="+chooseValue;
			myform.submit();
		}
	}
	...
	// 清空
	function f_clear(){
		document.getElementById("notemastername").value = "";
		document.getElementById("officeName").value = "";
		goSearch("tradePrizeRecord");
	}
	
	// 增加
	function f_add(){
		myform.action = "${pageContext.request.contextPath}/common/tradePrizeRecord.do?method=addAndEdit&param=add";
		myform.submit();
	}
	...
	function f_update(){
		...
		if(chooseValue==null || chooseValue==""){
			...
			myform.action = "${pageContext.request.contextPath}/common/tradePrizeRecord.do?method=addAndEdit&param=update&id="+chooseValue;
			myform.submit();
		}
	}
	...
	function f_delete(){
		...
		if(chooseValue==null || chooseValue==""){
			...
			if(confirm("确定要删除吗？")){
				myform.action = "${pageContext.request.contextPath}/common/tradePrizeRecord.do?method=deleteTradePrizeRecordTable&id="+chooseValue;
				myform.submit();
			}
		}
	}
	...
	function f_clear(){
		...
		document.getElementById("recordDate1").value = "";
		document.getElementById("recordDate2").value = "";
		f_quxiao();
		goSearch("tradePrizeRecord");
	}
