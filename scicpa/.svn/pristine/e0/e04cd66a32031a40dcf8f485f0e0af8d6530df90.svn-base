	...
	<input type="hidden" id="p" name="p" value="${p}">
		<br> <br>
			<table align="center" id="table" cellpadding="3px;">
				...
				<tr>
					<td class="color" width="20%" align="right" ><font style="font-size: 14">CPA号：</font></td>
					<td width="30%"><input class="input" id="loginid" name="loginid" value="${mr.loginid}" readonly="readonly"></td>
