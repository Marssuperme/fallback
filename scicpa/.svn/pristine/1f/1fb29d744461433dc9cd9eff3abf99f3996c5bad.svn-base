...
<table border="1" cellSpacing="0" cellPadding="0" width="100%" height="20%">
  ...
  <tr>
   ...
   <tr>
    ...
    <td width="577" height="16" colspan="3"><textarea id="blyjly" name="blyjly" style="width: 480px;height: 50px;">${cct.blyjly }</textarea></td>
  </tr>
   
  <tr>
    <td width="133" height="16" class="data_tb_alignright">无保留意见强调事项</td>
    <td width="577" height="16" colspan="3"><textarea id="notblyjly" name="notblyjly" style="width: 480px;height: 50px;">${cct.notblyjly }</textarea></td>
  </tr>
</table>
