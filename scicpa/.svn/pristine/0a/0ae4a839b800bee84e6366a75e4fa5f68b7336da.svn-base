	...
	<table height="100%" width="100%">
		<tr height="100%">
			<td width="20%" style="vertical-align: top">
				<div class="title">团组织资料维护</div>
				<table id="leftTb">
					<tr>
						<td>
							<A title="团组织基础资料" 
								href="${pageContext.request.contextPath}/common/memberBranch.do?method=branch" 
					...
					<tr>
						<td>
							<A title="本事务所中的团员列表" 
								href="${pageContext.request.contextPath}/common/member.do?method=member&goBackHidden=none" 
			...
			<td width="80%">
				<iframe src="${pageContext.request.contextPath}/common/memberBranch.do?method=branch"
