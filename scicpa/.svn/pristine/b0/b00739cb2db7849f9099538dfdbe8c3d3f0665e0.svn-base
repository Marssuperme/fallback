...
<table style="WIDTH: 100%; border: 0px;" class="data_tb" align="center">
	 <tr>
		<td class="data_tb_alignright" style="text-align: center;" colspan="4" height="38"><font style="font-size: 20">非&nbsp;&nbsp;培&nbsp;&nbsp;训&nbsp;&nbsp;学&nbsp;&nbsp;时&nbsp;&nbsp;申&nbsp;&nbsp;报</font></td>
	</tr>
	 
	<tr>
		<td class="data_tb_alignright" width="20%" height="18">申请确认的学时数：</td>
		<td class="data_tb_content" width="30%" height="18"> 
			<input maxlength="50" style="width: 65%" name="applyHours" type="text" id="applyHours" value="${at.applyHours }" disabled="disabled">
		</td>
		 
		<td class="data_tb_alignright" width="20%" height="18">参加继续教育的形式：</td>
		<td class="data_tb_content" height="18" width="30%"> 
			<input maxlength="50" name="educationType" style="width: 75%" type="text" id="educationType" value="${at.educationType}" disabled="disabled"
	...
	<tr>
		...
		<td class="data_tb_content" width="30%" height="18"> 
			<input maxlength="50" name="companyChecked" id="companyChecked" style="width: 65%" type="text" value="${at.companyChecked }" 
						onfocus="onPopDivClick(this);"
						onkeydown="onKeyDownEvent();"
						onkeyup="onKeyUpEvent();"
						onclick="onPopDivClick(this);"
	 ...
	 <tr>
		...
		<td class="data_tb_content" width="80%" height="18" colspan="3"> 
			<textarea  name="companyOpinion" id="companyOpinion" style="width: 90%" rows="3">${at.companyOpinion}</textarea>
		</td>
	</tr>
	 ...
	 <tr>
		...
		<td class="data_tb_content" width="80%" height="18" colspan="3"> 
			<textarea name="educationNote" id="educationNote" disabled="disabled" style="width: 90%" rows="8">${at.educationNote}</textarea> 
		</td>
	</tr>
</table>
<br>
		<c:if test="${at.provinceChecked!='审核通过'}">
			<input type="button" size="25" value="确定" icon="icon-save" onclick="f_save()">&nbsp;&nbsp;&nbsp;&nbsp;
		</c:if>
