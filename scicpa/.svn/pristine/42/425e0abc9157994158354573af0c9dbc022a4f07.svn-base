...
<table border="1" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
   ...
   <tr>
    ...
    <td width="30%" class="data_tb_content" colspan="3"><textarea id="blyjly" style="width: 500px;height: 50px;" name="blyjly">${qt.blyjly }</textarea></td>
  </tr>
  
   <tr>
    <td class="data_tb_alignright" width="20%">无保留意见强调事项</td>
    <td width="30%" class="data_tb_content" colspan="3"><textarea id="notblyjly" ${qt.blyjly } name="notblyjly" style="width: 500px;height: 50px;" >${qt.notblyjly }</textarea></td>
  </tr>
