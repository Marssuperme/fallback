...
<script>
	...
	function goView(chooseValue){
		window.location="${pageContext.request.contextPath}/common/document.do?method=document&nid="+chooseValue;
	}
	...
	function f_sure(){
		...
		//document.getElementById("myform").action = "${pageContext.request.contextPath}/common/document.do?method=dlist"; 
		//document.getElementById("myform").submit();
		var url = "${pageContext.request.contextPath}/common/document.do?method=dlist";
