package cn.org.gdicpa.web.service.yeepay;
...
public class YeepayService {
	...
	public YeepayService (String area) {
		this.area=area;
	}
	private   String area;
	/**
	...
	public  String getP1_MerId() {
		...
		return Configuration.getInstance().getValue("p1_MerId"+"_"+area);
	}
	...
	public  String getKeyValue() {
		return Configuration.getInstance().getValue("keyValue"+"_"+area);
	}
	 ...
	 */
	public  Map<String, String> queryByOrder (Map<String, String> params) throws UnsupportedEncodingException {
...
//							+ localHmac;
	 ...
	 */
	public  Map<String, String> refundByTrxId(Map<String, String> params) {
	 ...
	 * cancelOrder() : 订单撤销方法
	 */
	public  Map<String, String> cancelOrder(Map<String, String> params) {
