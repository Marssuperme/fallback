...
<script type="text/javascript">
	//新增
	function f_add(){
		document.getElementById("myform").action = "${pageContext.request.contextPath}/common/member.do?method=edit&param=add";
	...
	function f_update(){
		...
		if(chooseValue==null || chooseValue==""){
			...
			document.getElementById("myform").action = "${pageContext.request.contextPath}/common/member.do?method=edit&param=update&id="+chooseValue;
			document.getElementById("myform").submit();
		}
	}
