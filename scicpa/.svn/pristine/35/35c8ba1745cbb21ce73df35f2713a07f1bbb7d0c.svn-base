...
<form action="" method="post" name="myform" id="myform"> 
	...
	<div style="width:100%;">
	    ...
	    <div class="gridFrame">
		    ...
		    <br>
		    <div id="search" style="position:absolute;width:27%;height:15%; z-index:0;left:expression((document.body.clientWidth-400)/2);top:expression(this.offsetParent.scrollTop + 70); border:1px solid #6595d6; padding:1px; background:#ffffff; display: none;">
		    <br>
		   <fieldset  style="border: 1px solid lightblue;width:100%;height: 70%;margin-left: 2px;" id="fieldset">
				...
				<table>
		    		<tr>
		    			<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;申&nbsp;&nbsp;报&nbsp;&nbsp;者：&nbsp;&nbsp;&nbsp;<input id="loginName" name="loginName"></td>
		    		</tr>
		    		
		    		<tr>
		    			<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;申请年份：&nbsp;&nbsp;&nbsp;<input id="sYear" name="sYear" showcalendar="true"></td>
		    		</tr>
		    		<!--
		    		<tr  style="width: 52%">
		    	...
		    	<mt:DataGridPrintByBean name="conExmptinList"/>		   
		</div>
...
<script type="text/javascript" defer="defer">
	// 发起申请
	function f_add(){
		document.myform.action = "${pageContext.request.contextPath}/common/contentExemption.do?method=addGo";
		document.myform.submit();
	}

	// 修改
	function update(){
		var chooseValue = document.getElementById('chooseValue_conExmptinList').value ;
		
		if(chooseValue==null || chooseValue==""){
			alert("请选择要修改的记录!");
		}else{	
		    document.getElementById("id").value=chooseValue;
			document.myform.action = "${pageContext.request.contextPath}/common/contentExemption.do?method=selectCteExtionId";
			document.myform.submit();
		}
	}
	...
	function f_delete(){
		...
		if(chooseValue==null || chooseValue==""){
			...
			if(confirm("您确定要删除吗？")){
			    document.getElementById("id").value=chooseValue;
				document.getElementById("myform").action = "${pageContext.request.contextPath}/common/contentExemption.do?method=deleteCotetExtion";
	...
	function goView(id){
		...
		document.myform.action = "${pageContext.request.contextPath}/common/contentExemption.do?method=view";
		document.myform.submit();
	}
