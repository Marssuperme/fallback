...
<tr>
	...
	<tr height=18>
	  	...
	  	<td width="845" align="left" bgColor="#ffffff" >${documentMap.reference }</td>
	</tr>
	<tr height=18>
	  	<td height="20" align="center" bgColor="#EEEEEE"><strong>发文机构</strong></td>
	  	<td align="left" bgColor="#ffffff" >${documentMap.agencyname }</td>
	</tr>
	<tr height=18>
	...
	<!-- 
	<tr height=18>
	  	<td height="22" align="center" bgColor="#EEEEEE"><strong>主题词</strong></td>
	  	<td align="left" bgColor="#ffffff" >${documentMap.body }</td>
	</tr>
	 -->
	<tr>
		<td height="22" align="center" bgColor="#EEEEEE"><strong>正文</strong></td>
	 	<td align="left" bgColor="#FFFFFF"><div id = "${documentMap.attachmentid }"></div>
	 	</td>
	</tr>
	<tr>
...
try{
	$('#${documentMap.attachmentid }').uploadFile({
		indexId: '${documentMap.attachmentid }',
