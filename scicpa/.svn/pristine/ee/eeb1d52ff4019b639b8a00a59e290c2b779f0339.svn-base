...
function savePort(){
	...
	document.thisForm.action = "${pageContext.request.contextPath}/common/internship.do?method=saveport";
...
function saveScoring(){
	...
	var url="${pageContext.request.contextPath}/common/internship.do?method=savescoring&postid="+postid1+"&topicid="+topicid1+"&scoring="+scoring+"&random="+Math.random() ;
