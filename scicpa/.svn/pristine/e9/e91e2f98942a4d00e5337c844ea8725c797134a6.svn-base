...
<table style="width: 95%; border: 0px;margin-top: 20px;" class="data_tb" align="center">
	<tr>
		...
		<td class="data_tb_content" width="30%" height="18"> 
			<input id="meetingRoom" name="meetingRoom" value="${list[0].meetingRoom }" class="required">
		</td>
		<td class="data_tb_alignright" width="20%" height="18">培训班名称：<font color="#FF0000">[*]</font></td>
		<td class="data_tb_content" width="30%" height="18"> 
			<input id="trainingClass" name="trainingClass" value="${list[0].trainingClass }" class="required" readonly="readonly" style="color: #6b6969">
		</td>
	</tr>
	<tr>
		<td class="data_tb_alignright" width="20%" height="18">培训开始日期：<font color="#FF0000">[*]</font></td>
		<td class="data_tb_content" width="30%" height="18"> 
			<input id="trainingStartDate" name="trainingStartDate" showcalendar="true" value="${list[0].trainingStartDate }" class="required">
		</td>
		<td class="data_tb_alignright" width="20%" height="18">培训结束日期：<font color="#FF0000">[*]</font></td>
		<td class="data_tb_content" width="30%" height="18"> 
			<input id="trainingEndDate" name="trainingEndDate" showcalendar="true" value="${list[0].trainingEndDate }" class="required">
		</td>
	</tr>
	...
	<tr>
		...
		<td class="data_tb_content" width="30%" height="18"> 
			<input id="rows" name="rows" onkeyup="f_number(this)" onpaste="return false" value="${list[0].rows }" readonly="readonly" style="color: #6b6969">
		</td>
		<td class="data_tb_alignright" width="20%" height="18">座位列数：<font color="#FF0000">[*]</font></td>
		<td class="data_tb_content" width="30%" height="18"> 
			<input id="columns" name="columns" onkeyup="f_number(this)" onpaste="return false" value="${list[0].columns }" readonly="readonly" style="color: #6b6969">
		</td>
	</tr>
</table>
<table style="width: 95%; border: 0px;margin-top: 20px;" class="data_tb" align="center" id="seatTable">
	<tr>
		<td class="data_tb_content" colspan="4"> 
			<div id="seatPlan_div" style="text-align: center;width: 760px;height: 195px;overflow: auto;">
				<table class="TB">
					<c:forEach var="lr" items="${listRows}">
					 	<tr>
					 		<c:forEach var="lrDetail" items="${lr}">
					 			<td class="TD">
									<input id="seatno${lrDetail.orderno }" name="seatno" value="${lrDetail.seatno }" style="text-align:center;border:0px;width: 100%"><br>
									<input id="cpano${lrDetail.orderno }" name="cpano" title="${lrDetail.cpano }" focucmsg="<%=cpano_info %>" value="${lrDetail.cpano }" style="width: 100%;height: 0px;" onkeyup="f_changeStyle(this)" ><br>
									<input id="cpaName${lrDetail.orderno }" name="cpaName" title="${lrDetail.cpaName }" focucmsg="<%=cpaName_info %>" value="${lrDetail.cpaName }" style="margin-top:1px;width: 100%;height: 0px;" onkeyup="f_changeStyle(this)" >
								</td>
					 		</c:forEach>
					 	</tr>
					 </c:forEach>
