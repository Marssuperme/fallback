                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="data_tb_content" width="30%">
                      	<c:if test='${empty branch.branchtype }'>事务所工会</c:if>
                      	<c:if test='${!empty branch.branchtype }'>${branch.branchtype }</c:if>
                      	<input type="hidden" id="branchtype" name="branchtype" value="事务所工会"/>                      
                      </td>
                    </tr>
                    <tr>
                    <td class="data_tb_alignright">是否成立工会</td>
                    ...
                    <table style="PADDING-LEFT: 5px; PADDING-RIGHT: 5px;" border="0" cellSpacing="0" cellPadding="0" width="100%" align="center" height="100%">
                    <tr>
                      <td class="data_tb_alignright">工会名称<font color="#FF0000">&nbsp;[*]</font></td>
                      <td class="data_tb_content"><input value="${branch.branchname }" id="branchname" name="branchname" maxlength="50" type="text" size="30"></td>
                      <td class="data_tb_alignright" width="20%">工会成立时间<font color="#FF0000">&nbsp;[*]</font></td>
                    ...
                    <tr>
                      <td class="data_tb_alignright" width="20%">工会负责人<font color="#FF0000">&nbsp;[*]</font></td>
                      <td class="data_tb_content" width="30%"><input value="${branch.chairman }" id="chairman" name="chairman" maxlength="50" type="text" size="30"></td>
                      <td class="data_tb_alignright">负责人手机<font color="#FF0000">&nbsp;[*]</font></td>
                    ...
                    <tr>
                      <td class="data_tb_alignright" width="20%">职工人数<font color="#FF0000">&nbsp;[*]</font></td>
                      <td class="data_tb_content" width="30%"><input value="${branch.workernum }" name="workernum" maxlength="50" type="text"  id="workernum"  size="30" onkeyup="f_moneys(this);" ></td>
                      <td class="data_tb_alignright">工会成员数<font color="#FF0000">&nbsp;[*]</font></td>
                      <td class="data_tb_content"><input value="${branch.membernum }" name="membernum" maxlength="50" type="text"  id="membernum"  size="30" onkeyup="f_moneys(this);"></td>
                    </tr> 
                    <tr>
                      <td class="data_tb_alignright" width="20%">成员中cpa人数<font color="#FF0000">&nbsp;[*]</font></td>
                      <td class="data_tb_content" width="30%" colspan="3"><input value="${branch.cpanum }" name="cpanum" maxlength="50" type="text"  id="cpanum"  size="30" onkeyup="f_moneys(this);" ></td>
                    </tr> 
                    </table>
                    </span>
                    </td>
...
var arr1 = ["工会名称","工会成立时间","工会负责人","负责人手机","职工人数","工会成员数","成员中cpa人数 ","联系人","联系人手机"];
var arr2 = ["branchname","builddate","chairman","mobile","workernum","membernum","cpanum","linkman","phone"];

//保存
function saveCompany(){ 
	
	document.thisForm.action = "${pageContext.request.contextPath}/common/workerBranch.do?method=updateSave";
