		...
		for(var k=0;k<d.toolbars.length;k++){
			...
			for(var i=0;i<(toolbar.length);i++){
	            ...
	            // END: Custom button
				    ...
				    h += "<td valign='middle' align='center'><select id='"+d.id+"_highlight' onchange='global_hb[\""+d.id+"\"].cmd(\"backcolor\",this.options[this.selectedIndex].value);this.options[0].selected=\"true\";' style='font-size:12px;'><option value='' selected>-高亮-</option>";
				    ...
				    h += "<td valign='middle' align='center'><select id='"+d.id+"_syntax' onchange='global_hb[\""+d.id+"\"].cmd(\"syntax\",this.options[this.selectedIndex].value);this.options[0].selected=\"true\";' style='font-size:12px;'><option value='' selected>语法</option>";
				...
				// Commands
				var cmds = {"bold":"加粗","center":"居中","code":"查看源码","copy":"拷贝","cut":"剪切","hr":"插入水平线","link":"插入超连接","image":"插入图片","indent":"增加缩进量","italic":"斜体","justify":"两端对齐","left":"左对齐","ol":"编号","outdent":"减少缩进量","paragraph":"Insert Paragraph","paste":"粘帖","quote":"注释","redo":"恢复","removeformat":"删除格式","right":"右对齐","strike":"删除线","striptags":"Strip Tags","sub":"下标","sup":"上标","ul":"项目符号","underline":"下划线","undo":"撤销","unlink":"删除超链接"};
