...
<table border="1" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <td width="577" height="16" colspan="3"><input onfocus="onPopDivClick(this);"
						...
						norestorehint=true
						autoid=7
						hideresult=true id="bgyjlx" value="${st.bgyjlx }" name="bgyjlx" size="78"></td>
  </tr>
  
 
   <tr>
    <td width="103" height="16" class="data_tb_alignright">保留意见内容</td>
    <td width="577" height="16" colspan="3"><textarea id="blyj" style="width: 450px;height: 50px;" name="blyj">${st.blyj }</textarea></td>
  </tr>
  
   <tr>
    <td width="103" height="16" class="data_tb_alignright">无保留意见强调事项</td>
    <td width="577" height="16" colspan="3"><textarea id="notblyj" style="width: 450px;height: 50px;" name="notblyj">${st.notblyj }</textarea></td>
  </tr>
