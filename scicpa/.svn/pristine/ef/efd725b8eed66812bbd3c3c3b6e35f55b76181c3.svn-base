...
function saveCompanyJudge(){
	...
	if(ctguid=="" || ctguid==null){
		document.thisForm.action="${pageContext.request.contextPath}/common/sfkjjdb.do?method=addSfkjjdbTable";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}else{
		document.thisForm.action="${pageContext.request.contextPath}/common/sfkjjdb.do?method=updateSfkjjdbTableById";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}
