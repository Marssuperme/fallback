...
<table border="1" width="100%" cellpadding="0" style="padding-left: 2px" cellspacing="0">
  <tr>
    <td width="133" height="16" class="data_tb_alignright">评估目的</td>
    <td width="244" height="16"><input id="pgmd" value="${zt.pgmd}" name="pgmd" size="20"></td>
    <td width="142" height="16" class="data_tb_alignright">评估对象</td>
    <td width="179" height="16"><input id="pgdx" value="${zt.pgdx}" name="pgdx" size="15"></td>
  </tr>
  
  <tr>
    <td width="133" height="16" class="data_tb_alignright">价值类型</td>
    <td width="244" height="16"><input id="pglx" value="${zt.pglx}" name="pglx" size="20"></td>
    <td width="142" height="16" class="data_tb_alignright">评估方法</td>
    <td width="179" height="16"><input id="pgff" value="${zt.pgff}" name="pgff" size="15"></td>
  </tr>
  
   <tr>
    <td width="133" height="16" class="data_tb_alignright">评估基准日</td>
    <td width="244" height="16"><input id="pgjzr" value="${zt.pgjzr}" name="pgjzr" showcalendar="true" size="20" class="date"></td>
    <td width="142" height="16" class="data_tb_alignright">资产总额</td>
    <td width="179" height="16"><input id="zcze" value="${zt.zcze}" name="zcze" size="15" class="number"></td>
  </tr>
 
   <tr>
    <td width="133" height="16" class="data_tb_alignright">负债总额</td>
    <td width="244" height="16"><input id="fzze" value="${zt.fzze}" name="fzze" size="20" class="number"></td>
    <td width="142" height="16" class="data_tb_alignright">净增值额</td>
    <td width="179" height="16"><input id="jzze" value="${zt.jzze}" name="jzze" size="15" class="number"></td>
  </tr>
  
   <tr>
    <td width="133" height="16" class="data_tb_alignright">审计单位名称</td>
    <td width="577" height="16" colspan="3"><input id="sjdwmc" value="${zt.sjdwmc }" name="sjdwmc" size="88"></td>
  </tr>
...
function saveCompanyJudge(){
	var zcpgbguid = document.getElementById("zcpgbguid").value;
	if(zcpgbguid=="" || zcpgbguid==null){
		document.thisForm.action="${pageContext.request.contextPath}/common/bbzcpgb.do?method=addZcpgbTable";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}else{
		document.thisForm.action="${pageContext.request.contextPath}/common/bbzcpgb.do?method=updateZcpgbTableById";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}
...
// 返回
function goback(){	
	document.thisForm.action="${pageContext.request.contextPath}/common/bbzcpgb.do?method=index&typeid=zcpg001";
	thisForm.submit();
}
</script>
