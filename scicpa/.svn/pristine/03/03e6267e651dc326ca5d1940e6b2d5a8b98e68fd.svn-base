...
<input id="id" name="id" type="hidden" value="${cExemptionNot.id}">
<input id="hour" name="hour" type="hidden" value="${hour}">
<table style="WIDTH: 100%; border: 0px;" class="data_tb" align="center">
	 <tr>
		<td class="data_tb_alignright" style="text-align: center;" colspan="4" height="38"><font style="font-size: 20">非&nbsp;&nbsp;执&nbsp;&nbsp;业&nbsp;&nbsp;豁&nbsp;&nbsp;免&nbsp;&nbsp;学&nbsp;&nbsp;时&nbsp;&nbsp;申&nbsp;&nbsp;报</font></td>
	</tr>
	 
	<tr>
		<td class="data_tb_alignright" width="20%" height="18">申报年份：<font color="#FF0000">&nbsp;[*]</font></td>
		<td class="data_tb_content" width="30%" height="18"> 
				<input maxlength="30" value="${cExemptionNot.sYear }" name="sYear" class="required" title="请输入申报年份, 不能为空！" style="width: 30%" type="text" id="sYear"  >
		</td>
	 	<td class="data_tb_alignright" width="20%" height="18">申报日期：<font color="#FF0000">&nbsp;[*]</font></td>
		<td class="data_tb_content" height="18" width="30%"> 
			<input maxlength="30" name="sDate" class="required" title="请输入申报日期, 不能为空！" style="width: 30%" type="text" id="sDate" value=" ${cExemptionNot.sDate}" showcalendar="true">&nbsp;&nbsp; 
		</td>
	</tr>
 	<tr>
		...
		<td class="data_tb_content" width="30%" height="18" colspan="3"> 
			...
			onclick="onPopDivClick(this);" value="${cExemptionNot.EContent}"
			valuemustexist=true autoid=55 class="required" refer="contentExemptionNot" title="请输入豁免学时内容, 不能为空！"/>&nbsp;&nbsp; 
		</td>
	</tr>
	 <tr>
		<td class="data_tb_alignright" width="20%" height="18">豁免学时详细说明：</td>
		<td class="data_tb_content" width="80%" height="18" colspan="3"> 
			<textarea name="EHelp" id="EHelp" style="width: 90%" rows="8">${cExemptionNot.EHelp}</textarea> 
		</td>
	</tr>
</table>
<br>
...
//保存
function save(){
	document.myform.action = "${pageContext.request.contextPath}/common/ContentExemptionNot.do?method=save";
