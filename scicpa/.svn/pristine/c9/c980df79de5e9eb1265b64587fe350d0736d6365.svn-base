...
<body>
	<input type="hidden" value="" id="typeId" name="typeId">
	    <div class="gridFrame">
		    <div id="desc">待审核案例列表：</div>
			<div style="height:1px;border-top:1px solid #007500;width: 100%;"></div> 
		    <div> 
		    	<mt:DataGridPrintByBean name="auditCaseList"/>
		    </div>
		</div>
  <script type="text/javascript">
         ...
         function audit(chooseValue) {
        	...
        	window.location = "${pageContext.request.contextPath}/common/case.do?method=checkView&id="+chooseValue;
        }
    </script>
</body>
</html>
