...
<table border="1" cellpadding="0" style="padding-left: 2px" cellspacing="0" width="100%" height="20%">
  ...
  <tr>
    <td width="133" height="16" class="data_tb_alignright">外汇登记证号<font color="#FF0000">&nbsp;[*]</font></td>
    <td width="244" height="16"><input title="外汇登记证号" id="whdjzh" value="${wt.whdjzh}" name="whdjzh" size="20" class="required"></td>
    <td width="142" height="16" class="data_tb_alignright">币种<font color="#FF0000">&nbsp;[*]</font></td>
  ...
  <tr>
    <td width="133" height="16" class="data_tb_alignright">外汇收入总计</td>
    <td width="244" height="16"><input id="whsrzj" value="${wt.whsrzj}" name="whsrzj" size="20" class="number"></td>
    <td width="142" height="16" class="data_tb_alignright">处汇支出总计</td>
    <td width="179" height="16"><input id="whzczj" value="${wt.whzczj}" name="whzczj" size="15" class="number"></td>
  </tr>
  <tr>
    <td width="133" height="16" class="data_tb_alignright">经常项目差额</td>
    <td width="244" height="16"><input id="jcxmce" value="${wt.jcxmce}" name="jcxmce" size="20" class="number"></td>
    <td width="142" height="16" class="data_tb_alignright">其它资产</td>
    <td width="179" height="16"> 
    	<input id="qtzc" value="${wt.qtzc }" size="15" name="qtzc" class="number">
    </td>
  </tr>
  <tr>
    <td width="133" height="16" class="data_tb_alignright">外汇货币资金</td>
    <td width="244" height="16"><input id="whhbjj" value="${wt.whhbjj }" name="whhbjj" size="20" class="number"></td>
    <td width="142" height="16" class="data_tb_alignright">资产合计</td>
    <td width="179" height="16">
		<input id="jchj" value="${wt.jchj }" size="15" name="jchj" class="number"> 
	</td>
  </tr>
  <tr>
    <td width="133" height="16" class="data_tb_alignright">实收境外资本</td>
    <td width="244" height="16"><input id="ssjwjb" value="${wt.ssjwjb }" name="ssjwjb" size="20" class="number"></td>
    <td width="142" height="16" class="data_tb_alignright">实收境内外汇资本</td>
    <td width="179" height="16">
		<input id="ssjlwhjb" value="${wt.ssjlwhjb }" size="15" name="ssjlwhjb" class="number"> 
	</td>
  </tr>
  <tr>
    <td width="133" height="16" class="data_tb_alignright">境外借款</td>
    <td width="244" height="16"><input id="jwjk" value="${wt.jwjk }" name="jwjk" size="20" class="number"></td>
    <td width="142" height="16" class="data_tb_alignright">项目组人数</td>
    <td width="179" height="16"><input id="xmzrs" value="${wt.xmzrs }" name="xmzrs" size="15" class="number"></td>
  </tr>
  <tr>
    <td width="133" height="16" class="data_tb_alignright">外勤工作天数</td>
    <td width="577" colspan="3" height="16"><input id="wqgzts" value="${wt.wqgzts }" name="wqgzts" size="20" class="number"></td>
  </tr>
...
function saveCompanyJudge(){
	...
	var whnjguid = document.getElementById("whnjguid").value;
	if(whnjguid=="" || whnjguid==null){
		document.thisForm.action="${pageContext.request.contextPath}/common/bbwhnj.do?method=addWhnjTable";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}else{
		document.thisForm.action="${pageContext.request.contextPath}/common/bbwhnj.do?method=updateWhnjTableById";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}
...
// 返回
function goback(){	
	document.thisForm.action="${pageContext.request.contextPath}/common/bbwhnj.do?method=index&typeid=whnj001";
	thisForm.submit();
}
</script>
