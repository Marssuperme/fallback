	...
	<td width="60%">
		<table width="98%" border="0" cellpadding="0" cellspacing="0" > 
			<tr>
		       ...
		       <td><input id="loginid" name="loginid" value="${governmentTable.loginid }"></td>
		    </tr>
		    <tr>
		        <td align="right" width="40%">姓名：</td>
		        <td><input id="loginName" name="loginName" value="${governmentTable.loginName }"></td>
		    </tr>
			...
			<tr>
				...
				<a href="#" onClick="javascript:window.open('${pageContext.request.contextPath}/government/government.do?method=Help','','width=600, height=650, location=no, menubar=no, status=no, toolbar=no, scrollbars=yes, resizable=yes');">密码建议<label id="chkResult"></label></a>
				</td>
			</tr>
		  
		    <tr>
			   	<td align="right" width="40%">会员类型：</td>
			    <td><input id="ctype" name="ctype" value="${governmentTable.ctype }"></td>
			</tr>
			<tr>
			    <td align="right" width="40%">状态：</td>
			    <td><input id="state" name="state" value="${governmentTable.state }"></td>
		    </tr>
		  
			<tr>
			    <td align="right" width="40%">联系电话：</td>
			    <td><input id="phone" name="phone" value="${governmentTable.phone }"></td>
		    </tr>
		  
			<tr>
			    <td align="right" width="40%">所属单位：</td>
			    <td><input id="workunits" name="workunits" value="${governmentTable.workunits }"></td>
		   </tr>
...
<input name="pwd" type="hidden" id="pwd"  value="${governmentTable.pwd }"  >
<input name="ctypetabName" type="hidden" id="ctypetabName"  value="${governmentTable.ctypetabName }"  >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="37%" align="right">
      <input type="submit" name="next" value="保 存" class="flyBT" onclick="return saveGovernment();" >
    </td>
    <td width="8%">&nbsp;</td>
    <td width="55%"></td>
  </tr>
...
function f_validate1(){
		...
		var url="${pageContext.request.contextPath}/government/government.do?method=validate&pwdold="+pwdold;
...
function f_updatePwd(){
	...
	if(pwd_one == "" || pwd_one == null){
		...
		if(f_validate2()){
			var oBao = new ActiveXObject("Microsoft.XMLHTTP");
			var url="${pageContext.request.contextPath}/government/government.do?method=updatePwd&loginid="+loginid+"&pwdnow="+pwd_one ;
			oBao.open("POST",url,false);
			oBao.send();
...
//保存
function saveGovernment(){ 
	document.thisForm.action = "${pageContext.request.contextPath}/government/government.do?method=updateGovernmentTableById";
