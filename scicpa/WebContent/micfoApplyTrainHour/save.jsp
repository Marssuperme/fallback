...
<input id="id" name="id" type="hidden" value="${mTrainHour.id }">
<input id="loginid" name="loginid" type="hidden" value="${mTrainHour.loginid }">
<input id="loginName" name="loginName" type="hidden" value="${mTrainHour.loginName }">
<input id="companyChecked1" name="companyChecked1" type="hidden" value="${mTrainHour.companyChecked }">
<input id="provinceChecked1" name="provinceChecked1" type="hidden" value="${mTrainHour.provinceChecked }">
<input type="hidden" id="attachmentid" name="attachmentid" value="${mTrainHour.attachmentid }">
...
<input id="id" name="id" type="hidden" value="省注协审核">
<input id="hour" name="hour" type="hidden" value="${hour}">

<table style="WIDTH: 100%; border: 0px;" class="data_tb" align="center">
	 <tr>
		<td class="data_tb_alignright" style="text-align: center;" colspan="4" height="38"><font style="font-size: 20">执&nbsp;&nbsp;业&nbsp;&nbsp;会&nbsp;&nbsp;员&nbsp;&nbsp;其&nbsp;&nbsp;它&nbsp;&nbsp;训&nbsp;&nbsp;学&nbsp;&nbsp;时&nbsp;&nbsp;申&nbsp;&nbsp;报</font></td>
	</tr>
	...
	<tr>
		...
		<td class="data_tb_content" width="30%" height="18"> 
			<input onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="50" name="applyHours" style="width: 65%" type="text" id="applyHours" value="${mTrainHour.applyHours }" class="required">
		</td>
		...
		<td class="data_tb_content" height="18" width="30%"> 
			<input maxlength="50" name="educationType" style="width: 75%" type="text" id="educationType" value="${mTrainHour.educationType}" onfocus="onPopDivClick(this);"
	...
	<tr>
		...
		<td class="data_tb_content" width="30%" height="18"> 
			<input maxlength="50" name="companyChecked" id="companyChecked" style="width: 65%" disabled="disabled" type="text" value="${mTrainHour.companyChecked }" >
		</td>
		<td class="data_tb_alignright" width="20%" height="18">省注协审核：</td>
		<td class="data_tb_content" width="30%" height="18"> 
			<input maxlength="50" name="provinceChecked" id="provinceChecked" disabled="disabled" style="width: 75%" type="text" value = "${mTrainHour.provinceChecked }" >
		</td>
	</tr>
	 ...
	 <tr>
		...
		<td class="data_tb_content" width="80%" height="18" colspan="3"> 
			<textarea  name="companyOpinion" id="companyOpinion" disabled="disabled" style="width: 90%" rows="3">${mTrainHour.companyOpinion}</textarea>
		</td>
	</tr>
	 ...
	 <tr>
		...
		<td class="data_tb_content" width="80%" height="18" colspan="3"> 
			<textarea name="societyOpinion" id="societyOpinion" disabled="disabled" style="width: 90%" rows="3">${mTrainHour.societyOpinion}</textarea>
		</td>
	</tr>
	</c:if>
	 ...
	 <tr>
		...
		<td class="data_tb_content" width="80%" height="18" colspan="3"> 
			<textarea name="educationNote" id="educationNote" style="width: 90%" rows="8">${mTrainHour.educationNote}</textarea> 
		</td>
	</tr>
</table>
<br>
...
function f_save(){
	...
	document.myform.action = "${pageContext.request.contextPath}/common/MicfoApplyTrainHour.do?method=save";
