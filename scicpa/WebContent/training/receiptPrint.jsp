...
<form name="thisForm" method="post" action="">
		<div style="text-align: center;">
			<table cellpadding="10" cellspacing="10" style="width: 90%;word-break:break-all">
				<tr align="center">
					<td> <font style="font-size: 51px;font-family: 黑体, 仿宋">报名回执</font></td>
				</tr>
				<tr> 
					<td>
						<font style="font-size:33px;font-family: 仿宋;line-height:85px;">
							&nbsp;&nbsp;&nbsp;&nbsp;
							学员 ${mapInfo.loginname},CPA号为 ${mapInfo.cpano},
							报名参加由广东注册会计师协会举办的 ${mapInfo.trainingname },
							培训开始日期在  ${trainingbdate}，座位号是 ${mapInfo.seatno }号,请按通知要求准时参加培训。
						</font>
					</td> 
				</tr>
