	...
	<table height="100%" width="100%">
		<tr height="100%">
			<td width="20%" style="vertical-align: top">
				<div class="title">会员转所管理</div>
				<table id="leftTb">
					<tr>
						<td>
							<A title="显示会员详细资料" 
								href="${pageContext.request.contextPath}/micfo/micfo.do?method=transferClubList" 
								target=bodyFrame>&nbsp;&nbsp;转所申请</A>
						</td>
					</tr>
					<tr>
						<td>
			...
			<td width="80%">
				<iframe src="${pageContext.request.contextPath}/micfo/micfo.do?method=transferClubList"
