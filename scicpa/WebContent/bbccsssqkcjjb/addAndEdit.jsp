...
<table border="1" cellSpacing="0" style="padding-left: 2px" cellPadding="0" width="100%" height="20%">
  <tr>
    <td width="133" height="16" class="data_tb_alignright">财产损失类别<font color="#FF0000">&nbsp;[*]</font></td>
    ...
    <td width="142" height="16" class="data_tb_alignright">客户申报损失金额</td>
    <td width="179" height="16"><input id="khsbssje" value="${cct.khsbssje}" name="khsbssje" size="20" class="number"></td>
  </tr>
  
  <tr>
    <td width="133" height="16" class="data_tb_alignright">鉴证损失金额</td>
    <td width="244" height="16"><input id="jzssje" value="${cct.jzssje}" name="jzssje" size="20" class="number"></td>
   ...
   <tr>
    ...
    <td width="577" height="16" colspan="3"><textarea id="blyjly" name="blyjly" style="width: 490px;height: 50px;">${cct.blyjly }</textarea></td>
  </tr>
   
  <tr>
    <td width="133" height="16" class="data_tb_alignright">无保留意见强调事项</td>
    <td width="577" height="16" colspan="3"><textarea id="notblyjly" name="notblyjly" style="width: 490px;height: 50px;">${cct.notblyjly }</textarea></td>
  </tr>
</table>
...
function saveCompanyJudge(){
	var ccsssqkjjguid = document.getElementById("ccsssqkjjguid").value;
	if(ccsssqkjjguid=="" || ccsssqkjjguid==null){
		document.thisForm.action="${pageContext.request.contextPath}/common/bbccsssqkcjjb.do?method=addCcsssqkcjjbTable";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}else{
		document.thisForm.action="${pageContext.request.contextPath}/common/bbccsssqkcjjb.do?method=updateCcsssqkcjjbTableById";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}
...
// 返回
function goback(){	
	document.thisForm.action="${pageContext.request.contextPath}/common/bbccsssqkcjjb.do?method=index&typeid=ccsssqkcjj001";
	thisForm.submit();
}
</script>
