...
<table style="WIDTH: 100%; border: 0px;" class="data_tb" align="center">
	...
	<tr>
		...
		<td class="data_tb_content" width="30%" height="18"> 
			<input maxlength="50" name="applyHours" style="width: 65%" disabled="disabled" type="text" id="applyHours" value="${at.applyHours }">
		</td>
		 
		<td class="data_tb_alignright" width="20%" height="18">参加继续教育的形式：</td>
		<td class="data_tb_content" height="18" width="30%"> 
			<input maxlength="50" name="educationType" style="width: 75%" disabled="disabled" type="text" id="educationType" value="${at.educationType}" onfocus="onPopDivClick(this);"
	...
	<tr>
	 ...
	 <tr>
		...
		<td class="data_tb_content" width="80%" height="18" colspan="3"> 
			<textarea  name="companyOpinion" id="companyOpinion" readonly="readonly" style="width: 90%" rows="3">${at.companyOpinion}</textarea>
		</td>
	</tr>
	 ...
	 <tr>
		...
		<td class="data_tb_content" width="80%" height="18" colspan="3"> 
			<textarea name="societyOpinion" id="societyOpinion" readonly="readonly" style="width: 90%" rows="3">${at.societyOpinion}</textarea>
		</td>
	</tr>
	</c:if>
	 ...
	 <tr>
		...
		<td class="data_tb_content" width="80%" height="18" colspan="3"> 
			<textarea name="educationNote" id="educationNote" style="width: 90%" readonly="readonly" rows="8">${at.educationNote}</textarea> 
		</td>
	</tr>
</table>
<br>
