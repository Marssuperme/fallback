			...
			<table style="WIDTH: 100%" class="data_tb" align="center">
				<tbody>
					...
					<tr>
						...
						<td class="data_tb_content" width="30%" height="18"><input type="text" class="required" value="${userMap.loginname }" id="name3"/></td>
						<td class="data_tb_alignright" width="50%" style="text-align: center" colspan="2" rowspan="5"
							height="111"><img id="bill" height="120" width="100" src="${pageContext.request.contextPath}${userPhotoSrc }"><br>
								...
								<span id="logospan" style="display:;">
					...
					<tr>
						...
						<td class="data_tb_content" width="30%" height="39"><input
							...
							value="${userMap.borndate }"  class="required"></td>
					</tr>
					<tr>
						...
						<td class="data_tb_content" width="30%" height="39">
							<input name="idnumber" type="text" id="idnumber" size="25"  class="required" value="${userMap.idnumber }" ></td>
					</tr>
					<tr>
						<td class="data_tb_alignright" style="text-align: left;
					...
					<tr>
						...
						<td class="data_tb_content" height="18" colspan="3">
							<input name="officename" type="text" id="officename"  size="25"  value = "${userMap.officename }"  class="required">
						</td>
					</tr>
					<tr>
						<td class="data_tb_alignright" height="18">事务所代码<font color="#FF0000">&nbsp;[*]</font></td>
						<td class="data_tb_content" height="18"><input  class="required" name="officecode" type="text" id="officecode"  size="25"  value = "${userMap.officecode }"></td>
					...
					<tr>
						...
						<td class="data_tb_content" height="18"><input name="cpano" type="text" id="cpano"  size="25"  value = "${userMap.cpano }"  class="required"></td>
						<td class="data_tb_alignright" height="18">注师批准文号<font color="#FF0000">&nbsp;[*]</font></td>
						<td class="data_tb_content" height="18"><input name="cpapermitno" type="text" id="cpapermitno"  size="25"  value = "${userMap.cpapermitno }"  class="required"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="data_tb_content" height="18"><input name="approve" type="text" id="approve"  size="25"  value = "${userMap.approve }"  class="required"></td>
					</tr>
					...
					<tr>
						...
						<td class="data_tb_content" height="18"><input name="filestorage" type="text" id="filestorage"  size="25"  value = "${userMap.filestorage }"  class="required"></td>
					...
					<tr>
						...
						<td class="data_tb_content" height="18" colspan="3">
							<input name="general" type="text" id="general"  size="25"  value = "${userMap.general }"  class="required">
						</td>
					</tr>
					<tr>
						<td class="data_tb_alignright" style="text-align: left;"
