	    ...
	    <div class="gridFrame">
		   ...
		   <fieldset  style="border: 1px solid lightblue;width:100%;height: 70%;margin-left: 2px;" id="fieldset">
				...
				<table>
		    		...
		    		<tr>
		    			<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;填&nbsp;&nbsp;&nbsp;报&nbsp;&nbsp;&nbsp;时&nbsp;&nbsp;间：&nbsp;&nbsp;&nbsp;&nbsp;<input id="fillTime1" name="fillTime1" showcalendar="true"></td>
		    		</tr>
		    		<tr>
		    			<td colspan="1" style="width: 22%">&nbsp;</td>
		    			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;至&nbsp;<input id="fillTime2" name="fillTime2" showcalendar="true"></td>
		    		</tr>
		    	</table>
		    	<br>
...
// 发起申请
function f_add(){
	document.myform.action = "${pageContext.request.contextPath}/common/projectFill.do?method=go&opt=add";
...
function f_update(){
	...
	if(chooseValue==null || chooseValue==""){
		...
		document.myform.action = "${pageContext.request.contextPath}/common/projectFill.do?method=go&opt=update&id="+chooseValue;
		document.myform.submit();
	}
...
function f_delete(){
	...
	if(chooseValue==null || chooseValue==""){
		...
		if(confirm("您确定要删除吗？")){
			document.myform.action = "${pageContext.request.contextPath}/common/projectFill.do?method=delete&id="+chooseValue;
			document.myform.submit();
		}
	}
}
...
function grid_dblclick(trObj) {
	var id = trObj.id;
	document.myform.action = "${pageContext.request.contextPath}/common/projectFill.do?method=view&id="+id;
	document.myform.submit();
}
...
function f_clear(){
	...
	document.getElementById("fillTime1").value = "";
	document.getElementById("fillTime2").value = "";
	f_quxiao();
	goSearch("projectFillList");
}
