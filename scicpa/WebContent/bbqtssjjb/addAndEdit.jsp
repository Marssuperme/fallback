...
<table border="1" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <td width="30%" class="data_tb_content"><input id="srze" value="${qt.srze}" name="srze" size="20" class="number"></td>
    <td width="20%" class="data_tb_alignright">销售（营业）收入</td>
    <td width="30%" class="data_tb_content"><input id="xssr" value="${qt.xssr}" name="xssr" size="20" class="number"></td>
  </tr>
  <tr>
    <td width="20%" class="data_tb_alignright">销售（营业）成本</td>
    <td width="30%" class="data_tb_content"><input id="xscb" value="${qt.xscb}" name="xscb" size="20" class="number"></td>
    <td width="20%" class="data_tb_alignright">其间费用</td>
    <td width="30%" class="data_tb_content"><input id="qjfy" value="${qt.qjfy}" name="qjfy" size="20" class="number"></td>
  </tr>
  <tr>
    <td width="20%" class="data_tb_alignright">利润总额</td>
    <td width="30%" class="data_tb_content"><input id="lrze" value="${qt.lrze}" name="lrze" size="20" class="number"></td>
    <td width="20%" class="data_tb_alignright">纳税调整前所得额</td>
    <td width="30%" class="data_tb_content"> 
    	<input id="lstzqsde" value="${qt.lstzqsde }" size="20" name="lstzqsde" class="number">
    </td>
  </tr>
  <tr>
    <td width="20%" class="data_tb_alignright">纳税调整增加额</td>
    <td width="30%" class="data_tb_content"><input id="lstzzje" value="${qt.lstzzje }" name="lstzzje" size="20" class="number"></td>
    <td width="20%" class="data_tb_alignright">纳税调整减少额</td>
    <td width="30%" class="data_tb_content">
		<input id="lstzjse" value="${qt.lstzjse }" size="20" name="lstzjse" class="number"> 
	</td>
  </tr>
  <tr>
    <td width="20%" class="data_tb_alignright">应纳税所得额</td>
    <td width="30%" class="data_tb_content"><input id="ylssde" value="${qt.ylssde }" name="ylssde" size="20" class="number"></td>
    <td width="20%" class="data_tb_alignright">适用税率(%)<font color="#FF0000">&nbsp;[*]</font></td>
    <td width="30%" class="data_tb_content">
		<input title="适用税率" id="sysl" value="${qt.sysl }" size="20" name="sysl" class="required number"> 
	</td>
  </tr>
  <tr>
    <td width="20%" class="data_tb_alignright">实际应纳税所得额</td>
    <td width="30%" class="data_tb_content"><input id="sjylssd" value="${qt.sjylssd }" name="sjylssd" size="20" class="number"></td>
    <td width="20%" class="data_tb_alignright">已预缴所得税额</td>
    <td width="30%" class="data_tb_content"><input id="yyjsdse" value="${qt.yyjsdse }" name="yyjsdse" size="20" class="number"></td>
  </tr>
  
  <tr>
    <td width="20%" class="data_tb_alignright">本期应补</td>
    <td width="30%" class="data_tb_content"><input id="bqybsdlse" value="${qt.bqybsdlse }" name="bqybsdlse" size="20" class="number"></td>
  ...
  <tr>
    ...
    <td width="30%" class="data_tb_content"><input id="gsswdjh" value="${qt.gsswdjh }" name="gsswdjh" size="20"></td>
    <td width="20%" class="data_tb_alignright">地税税务登记证号</td>
    <td width="30%" class="data_tb_content"><input id="dsswdjh" value="${qt.dsswdjh }" name="dsswdjh" size="20"></td>
  </tr>
  
  <tr>
    <td width="20%" class="data_tb_alignright">受理税务机关名称<font color="#FF0000">&nbsp;[*]</font></td>
    <td width="30%" class="data_tb_content"><input title="受理税务机关名称" id="slswjgmc" value="${qt.slswjgmc }" name="slswjgmc" size="20" class="required"></td>
   ...
   <tr>
    ...
    <td width="30%" class="data_tb_content" colspan="3"><textarea id="blyjly" style="width: 450px;height: 50px;" name="blyjly">${qt.blyjly }</textarea></td>
  </tr>
  
   <tr>
    <td class="data_tb_alignright" width="20%">无保留意见强调事项</td>
    <td width="30%" class="data_tb_content" colspan="3"><textarea id="notblyjly" ${qt.blyjly } name="notblyjly" style="width: 450px;height: 50px;" >${qt.notblyjly }</textarea></td>
  </tr>
...
function saveCompanyJudge(){
	var qtssjjbguid = document.getElementById("qtssjjbguid").value;
	if(qtssjjbguid=="" || qtssjjbguid==null){
		document.thisForm.action="${pageContext.request.contextPath}/common/bbqtssjjb.do?method=addQtssjjbTable";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}else{
		document.thisForm.action="${pageContext.request.contextPath}/common/bbqtssjjb.do?method=updateQtssjjbTableById";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}
...
// 返回
function goback(){	
	document.thisForm.action="${pageContext.request.contextPath}/common/bbqtssjjb.do?method=index&typeid=qtssjj001";
	thisForm.submit();
}
