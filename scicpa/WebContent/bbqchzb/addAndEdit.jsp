...
<table border="1" cellpadding="0" cellspacing="0" style="padding-left: 2px" width="100%">
  <tr>
    <td width="133" height="16" class="data_tb_alignright">资产总额</td>
    <td width="244" height="16"><input id="zcze" value="${qt.zcze}" name="zcze" size="20" class="number"></td>
    <td width="142" height="16" class="data_tb_alignright">负债总额</td>
    <td width="179" height="16"><input id="fzze" value="${qt.fzze}" name="fzze" size="15" class="number"></td>
  </tr>
  
 
  <tr>
   <td width="133" height="16" class="data_tb_alignright">净增值额</td>
   <td width="244" height="16" colspan="3"><input id="jzze" value="${qt.jzze}" name="jzze" size="20" class="number"></td>
  </tr>
</table>
...
function saveCompanyJudge(){
	var qchzbguid = document.getElementById("qchzbguid").value;
	if(qchzbguid=="" || qchzbguid==null){
		document.thisForm.action="${pageContext.request.contextPath}/common/bbqchzb.do?method=addQchzbTable";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}else{
		document.thisForm.action="${pageContext.request.contextPath}/common/bbqchzb.do?method=updateQchzbTableById";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}
...
// 返回
function goback(){	
	document.thisForm.action="${pageContext.request.contextPath}/common/bbqchzb.do?method=index&typeid=qchz001";
	thisForm.submit();
}
