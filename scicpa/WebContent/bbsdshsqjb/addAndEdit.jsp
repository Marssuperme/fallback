...
<table border="1" cellpadding="0" style="padding-left: 2px" cellspacing="0" width="100%">
  <tr>
    <td class="data_tb_alignright" style="text-align: left;" width="597" colspan="4" height="16">纳税信息</td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">收入总额</td>
    <td width="244" height="23"><input id="srze" value="${st.srze}" name="srze" size="20" class="number"> </td>
    <td width="142" height="23" class="data_tb_alignright">销售（营业）收入</td>
    <td width="179" height="23"><input id="xssr" value="${st.xssr}" name="xssr" size="15" class="number"> </td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">销售（营业）成本</td>
    <td width="244" height="23"><input id="xscb" value="${st.xscb}" name="xscb" size="20" class="number"></td>
    <td width="142" height="23" class="data_tb_alignright">利润总额</td>
    <td width="179" height="23"><input id="lrze" value="${st.lrze}" name="lrze" size="15" class="number"></td>
  </tr>
  <tr>
    <td width="103" height="46" class="data_tb_alignright">纳税调整前所得额</td>
    <td width="244" height="46"><input id="lstzqsde" value="${st.lstzqsde}" name="lstzqsde" size="20" class="number"></td>
    <td width="142" height="46" class="data_tb_alignright">纳税调整增加额</td>
    <td width="179" height="46"> 
    	<input id="lstzzje" value="${st.lstzzje }" size="15" name="lstzzje" class="number"> 
    </td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">纳税调整减少额</td>
    <td width="244" height="23"><input id="lstzjse" value="${st.lstzjse }" name="lstzjse" size="20" class="number"></td>
    <td width="142" height="23" class="data_tb_alignright">应纳税所得额</td>
    <td width="179" height="23">
		<input id="ylssde" value="${st.ylssde }" size="15" name="ylssde" class="number"> 
	</td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">适用税率(%)<font color="#FF0000">&nbsp;[*]</font></td>
    <td width="244" height="23"><input title="适用税率" id="sysl" value="${st.sysl }" name="sysl" size="20" class="required number"></td>
    <td width="142" height="23" class="data_tb_alignright">其间费用（管理费用、销售费用、财务费用）</td>
    <td width="179" height="23">
		<input id="qjfy" value="${st.qjfy }" size="15" name="qjfy"  class="number"> 
	</td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">实际应纳税所得额</td>
    <td width="244" height="23"><input id="sjylssd" value="${st.sjylssd }" name="sjylssd" size="20" class="number"></td>
    <td width="142" height="23" class="data_tb_alignright">已预缴所得税额</td>
    <td width="179" height="23"><input id="yjlssde" value="${st.yjlssde }" name="yjlssde" size="15" class="number"></td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">本期应补（退、抵）所得税额</td>
    <td width="577" colspan="3" height="23"><input id="bqybsde" value="${st.bqybsde }" name="bqybsde" size="20" class="number"></td>
  </tr>
  <tr>
    <td class="data_tb_alignright" style="text-align: left;" width="597" colspan="4" height="16">税务信息</td>
  </tr>
  <tr>
    <td width="103" height="10" class="data_tb_alignright">受理税务机关<font color="#FF0000">&nbsp;[*]</font></td>
    <td width="244" height="10"><input onfocus="onPopDivClick(this);"
    					noinput=true
						onkeydown="onKeyDownEvent();"
						onkeyup="onKeyUpEvent();"
						onclick="onPopDivClick(this);"
						norestorehint=true
						autoid=19
						hideresult=true title="受理税务机关" id="slswjg" value="${st.slswjg }" size="15" name="slswjg" class="required"></td>
    <td class="data_tb_alignright" width="142" class="data_tb_alignright">国税税务登记证号</td>
    <td class="data_tb_content" width="179"><input id="gsswdjh" value="${st.gsswdjh }" size="15" name="gsswdjh"></td>
  </tr>
  <tr>
    <td width="103" height="16" class="data_tb_alignright">地税税务登记证号&nbsp;</td>
    <td width="244" height="16"><input id="dsswdjh" value="${st.dsswdjh }" size="15" name="dsswdjh"></td>
    <td width="142" height="16" class="data_tb_alignright">受理税务机关名称</td>
    <td width="179" height="16"><input id="sjswjgmc" value="${st.sjswjgmc }" name="sjswjgmc" size="15"></td>
  </tr>
  <tr>
    <td width="103" height="16" class="data_tb_alignright">报告意见类型</td>
    <td width="577" height="16" colspan="3"><input onfocus="onPopDivClick(this);"
    					noinput=true
						onkeydown="onKeyDownEvent();"
						onkeyup="onKeyUpEvent();"
						onclick="onPopDivClick(this);"
						norestorehint=true
						autoid=7
						hideresult=true id="bgyjlx" value="${st.bgyjlx }" name="bgyjlx" size="88"></td>
  </tr>
  
 
   <tr>
    <td width="103" height="16" class="data_tb_alignright">保留意见内容</td>
    <td width="577" height="16" colspan="3"><textarea id="blyj" style="width: 470px;height: 50px;" name="blyj">${st.blyj }</textarea></td>
  </tr>
  
   <tr>
    <td width="103" height="16" class="data_tb_alignright">无保留意见强调事项</td>
    <td width="577" height="16" colspan="3"><textarea id="notblyj" style="width: 470px;height: 50px;" name="notblyj">${st.notblyj }</textarea></td>
  </tr>
...
function saveCompanyJudge(){
	var stguid = document.getElementById("stguid").value;
	if(stguid=="" || stguid==null){
		document.thisForm.action="${pageContext.request.contextPath}/common/bbsdshsqjb.do?method=addSdshsqjTable";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}else{
		document.thisForm.action="${pageContext.request.contextPath}/common/bbsdshsqjb.do?method=updateSdshsqjTableById";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}
...
// 返回
function goback(){	
	document.thisForm.action="${pageContext.request.contextPath}/common/bbsdshsqjb.do?method=index&typeid=sdshsqj001";
	thisForm.submit();
}
</script>
