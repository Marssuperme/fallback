...
<form action="" method="post" name="myform" id="myform"> 
	    ...
	    <div class="gridFrame" >
		    ...
		    <div style="width:100%;overflow:auto;height:85%;"> 
		    	<mt:DataGridPrintByBean name="partyExpansion"/>
		    </div>
		</div>
<input name="tablename" type="hidden" id="tablename"  value="K_PartyExpansion"  >
<input name="url" type="hidden" id="url"  value="/common/partyBranch.do?method=expansion"  >
...
<script type="text/javascript">
	// 修改
	function f_update(){
		var chooseValue = document.getElementById('chooseValue_partyExpansion').value ;
