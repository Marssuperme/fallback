...
<table style="WIDTH: 100%; border: 0px;" class="data_tb" align="center">
	...
	<tr>
		...
		<td class="data_tb_content" width="30%" height="18"> 
				<input maxlength="30" value="${cExemptionNot.sYear }" name="sYear" readonly="readonly" title="请输入申报年份, 不能为空！" style="width: 30%" type="text" id="sYear"  >
		</td>
	 	<td class="data_tb_alignright" width="20%" height="18">申报日期：<font color="#FF0000">&nbsp;[*]</font></td>
		<td class="data_tb_content" height="18" width="30%"> 
			<input maxlength="30" name="sDate" class="required" title="请输入申报日期, 不能为空！" type="text" id="sDate" value="${cExemptionNot.sDate}" readonly="readonly"  >&nbsp;&nbsp; 
		</td>
	</tr>
 	...
 	<tr>
		...
		<td class="data_tb_content" width="30%" height="18" colspan="3"> 
			<input type="text" name="EConten" id="EConten" size="46"  value="${cExemptionNot.EContent}"  class="required" readonly="readonly" title="请输入豁免学时内容, 不能为空！"/>&nbsp;&nbsp; 
		</td>
	</tr>
	 <tr>
		<td class="data_tb_alignright" width="20%" height="18">豁免学时详细说明：</td>
		<td class="data_tb_content" width="80%" height="18" colspan="3"> 
			<textarea name="EHelp" id="EHelp" style="width: 90%" rows="8" readonly="readonly" >${cExemptionNot.EHelp}</textarea> 
		</td>
	</tr>
</table>
<br>
