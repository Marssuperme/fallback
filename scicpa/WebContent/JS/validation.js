...
Validation.prototype = {
	initialize : function(form, options){
		...
		this.form = $(form);
		//this.form.attachEvent('submit',this.onSubmit.bind(this));
		//Event.observe(this.form,'submit',function(){alert('test submit')},false);
...
Object.extend(Validation, {
	...
	test : function(name) {
		...
		if(Validation.isVisible(this) && !v.test(Validation.trim(  ((this.type=="file") ? this.value : $F(this))     ))) {
			passed=false;
		}else{
