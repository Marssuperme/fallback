...
function doLoadCalendar()
{
	...
	for ( i = 0; i < oInputs.length; i++ )
	{
		...
		if (oInputs(i).showcalendar  && !obj) 
		{
			...
			oInputs(i).insertAdjacentHTML("afterEnd", "<input type=button id=\"date_"+oInputs(i).uniqueID+"\" value=\"Ñ¡Ôñ\" class=\"flyBT\" style=\"height=22;"+display+"\" onclick=\"return showCalendar('"+oInputs(i).uniqueID+"', 'y-mm-dd');\">");  
