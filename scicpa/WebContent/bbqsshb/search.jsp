...
<table border="1" cellpadding="0" cellspacing="0" width="100%" height="20%">
  ...
  <tr>
   ...
   <tr>
    ...
    <td width="577" height="16" colspan="3"><textarea id="bjyjly" style="width: 480px;height: 50px;" name="bjyjly">${qt.bjyjly }</textarea></td>
  </tr>
   
  <tr>
    <td width="133" height="16" class="data_tb_alignright">无保留意见强调事项</td>
    <td width="577" height="16" colspan="3"><textarea id="notblyjly" style="width: 480px;height: 50px;" name="notblyjly">${qt.notblyjly }</textarea></td>
  </tr>
</table>
