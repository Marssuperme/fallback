...
<table border="1" cellpadding="0" cellspacing="0" style="padding-left: 2px;" width="100%">
  <tr>
    <td class="data_tb_alignright" style="text-align: left;" width="597" colspan="4" height="16">审计信息</td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">审计类型<font color="#FF0000">&nbsp;[*]</font></td>
    <td width="244" height="23"><input onfocus="onPopDivClick(this);"
    					noinput=true
						onkeydown="onKeyDownEvent();"
						onkeyup="onKeyUpEvent();"
						onclick="onPopDivClick(this);"
						norestorehint=true
						autoid=16
						hideresult=true title="审计类型" id="sjlx" value="${st.sjlx}" name="sjlx" size="20" class="required"></td>
    <td width="142" height="23" class="data_tb_alignright">专项审计名称</td>
    <td width="179" height="23"><input id="zxsjmc" value="${st.zxsjmc}" name="zxsjmc" size="20"></td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">报告用途</td>
    <td width="244" height="23"><input id="bgyt" value="${st.bgyt}" name="bgyt" size="20"></td>
    <td width="142" height="23" class="data_tb_alignright">报表年度</td>
    <td width="179" height="23"><input onfocus="onPopDivClick(this);"
    					noinput=true
    					autoWidth=180
    					autoHeight=180
						onkeydown="onKeyDownEvent();"
						...
						norestorehint=true
						autoid=3
						hideresult=true id="sjbgnd" value="${st.sjbgnd}" name="sjbgnd" size="15"></td>
  </tr>
  <tr>
    <td width="103" height="46" class="data_tb_alignright">合并户数</td>
    <td width="244" height="46"><input id="hbhs" value="${st.hbhs}" name="hbhs" size="20" class="number"></td>
    <td width="142" height="46" class="data_tb_alignright">控股上市公司数</td>
    <td width="179" height="46"> 
    	<input id="kgssgss" value="${st.kgssgss }" size="15" name="kgssgss" class="number">
    </td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">股票代码</td>
    <td width="244" height="23"><input id="gpdm" value="${st.gpdm }" name="gpdm" size="20"></td>
    <td width="142" height="23" class="data_tb_alignright">是否连续审计</td>
    <td width="179" height="23">
		<input onfocus="onPopDivClick(this);"
						...
						norestorehint=true
						autoid=20
						hideresult=true id="sflxsj" value="${st.sflxsj }" size="15" name="sflxsj"> 
	</td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">前任会计师事务所名称</td>
    <td width="244" height="23"><input id="qykjsswsmc" value="${st.qykjsswsmc }" name="qykjsswsmc" size="20"></td>
    <td width="142" height="23" class="data_tb_alignright">审计报告意见类型<font color="#FF0000">&nbsp;[*]</font></td>
    <td width="179" height="23">
		<input onfocus="onPopDivClick(this);"
    					noinput=true
    					autoWidth=180
						...
						norestorehint=true
						autoid=7
						hideresult=true id="sjbgyjlx" value="${st.sjbgyjlx }" title="审计报告意见类型" size="15" name="sjbgyjlx" class="required"> 
	</td>
  </tr>
  
  <tr>
    <td width="103" height="23" class="data_tb_alignright">销售收入</td>
    <td width="244" height="23"><input id="xssr" value="${st.xssr }" name="xssr" size="20" class="number"></td>
    <td width="142" height="23" class="data_tb_alignright">营业收入</td>
    <td width="179" height="23">
		<input id="yysr" value="${st.yysr }" size="15" name="yysr" class="number"> 
	</td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">资产总额</td>
    <td width="244" height="23"><input id="zcze" value="${st.zcze }" name="zcze" size="20" class="number"></td>
    <td width="142" height="23" class="data_tb_alignright">负责总额</td>
    <td width="179" height="23"><input id="fzze" value="${st.fzze }" name="fzze" size="15" class="number"></td>
  </tr>
  
  <tr>
    <td width="103" height="23" class="data_tb_alignright">利润总额</td>
    <td width="244" height="23"><input id="lrze" value="${st.lrze }" name="lrze" size="20" class="number"></td>
    <td width="142" height="23" class="data_tb_alignright">应纳税所得额</td>
    <td width="179" height="23">
		<input id="ylsde" value="${st.ylsde }" size="15" name="ylsde" class="number"> 
	</td>
  </tr>
  <tr>
    <td width="103" height="23" class="data_tb_alignright">净利润</td>
    <td width="244" height="23"><input id="jlr" value="${st.jlr }" name="jlr" size="20" class="number"></td>
    <td width="142" height="23" class="data_tb_alignright">应纳所得税额</td>
    <td width="179" height="23"><input id="ylsdse" value="${st.ylsdse }" name="ylsdse" size="15" class="number"></td>
  </tr>
   
  <tr>
    <td width="103" height="23" class="data_tb_alignright">项目组人数</td>
    <td width="244" height="23"><input id="xmzrs" value="${st.xmzrs }" name="xmzrs" size="20" class="number"></td>
    <td width="142" height="23" class="data_tb_alignright">外勤工作天数</td>
    <td width="179" height="23"><input id="wqgzts" value="${st.wqgzts }" name="wqgzts" size="15" class="number"></td>
  </tr>
  
   <tr>
    <td class="data_tb_alignright" width="103" height="16">保留意见内容</td>
    <td width="577" height="16" colspan="3"><textarea style="width: 470px;height: 50px;" id="blyjlx" name="blyjlx" size="75">${st.blyjlx }</textarea></td>
  </tr>
  
   <tr>
    <td class="data_tb_alignright" width="103" height="16">无保留意见强调事项</td>
    <td width="577" height="16" colspan="3"><textarea style="width: 470px;height: 50px;" id="notblyjlx" name="notblyjlx" size="75">${st.notblyjlx }</textarea></td>
  </tr>
...
function saveCompanyJudge(){
	var sjguid = document.getElementById("sjguid").value;
	if(sjguid=="" || sjguid==null){
		document.thisForm.action="${pageContext.request.contextPath}/common/bbsjb.do?method=addSjTable";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}else{
		document.thisForm.action="${pageContext.request.contextPath}/common/bbsjb.do?method=updateSjTableById";
		if (thisForm.fireEvent('onsubmit')){
			document.thisForm.submit();
		}
	}
...
// 返回
function goback(){	
	document.thisForm.action="${pageContext.request.contextPath}/common/bbsjb.do?method=index&typeid=sj001";
	thisForm.submit();
}
</script>
