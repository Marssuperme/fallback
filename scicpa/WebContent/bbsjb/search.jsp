...
<table border="1" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
   ...
   <tr>
    ...
    <td width="577" height="16" colspan="3"><textarea style="width: 450px;height: 50px;" id="blyjlx" name="blyjlx" size="75">${st.blyjlx }</textarea></td>
  </tr>
  
   <tr>
    <td class="data_tb_alignright" width="103" height="16">无保留意见的意见</td>
    <td width="577" height="16" colspan="3"><textarea style="width: 450px;height: 50px;" id="notblyjlx" name="notblyjlx" size="75">${st.notblyjlx }</textarea></td>
  </tr>
