...
<script>
	// 查看
	function f_viewTD(guid,companyguid,typeid){
		var url = "${pageContext.request.contextPath}/common/bb.do?method=addAndEdit&GUID="+guid+"&param=search&p=ck&typeid="+typeid;
		window.location = url;
	}
