...
<form name="thisForm" id="thisForm" method="post" enctype="multipart/form-data" >
	...
	<input name="btype" type="hidden" id="btype"  value="招聘"  >
...
<script type="text/javascript">
	...
	$('#attachment').uploadFile({
   	...
   	var AllExt=".doc|.xls|.rar|.zip|.jpg|.jpeg|.gif|.bmp|.png|";//全部格式类型 
	function saveInfo(){
		...
		document.thisForm.action = "${pageContext.request.contextPath}/common/recruitment.do?method=save";
