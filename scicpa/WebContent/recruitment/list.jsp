...
/*增加*/
function goAdd(){
	window.location="${pageContext.request.contextPath}/common/recruitment.do?method=add";
}
...
*/	
	window.location="${pageContext.request.contextPath}/common/recruitment.do?method=view&topicid="+chooseValue;
}

/*删除*/
function goDel(){
	window.location="${pageContext.request.contextPath}/common/recruitment.do?method=indexdel&loginid=${userSession.userMap.loginid}"
}
</script>
