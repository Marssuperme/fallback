	...
	<form id="thisForm" name="thisForm" method="post">
		...
		事务所名称：<input type="text" readonly="readonly" id="departname" name="departname" title="请输入事务所名称"
		    ...
		    <span style="margin-left:150px;">
				会费年度：<input type="text" id="iyear" name="iyear" class="required" value="${iyear}" style="border:0px;border-bottom:1px solid #aaa;" title="请输入会费缴纳年度" readonly="readonly">
			</span>
		...
		<table id="tb2" cellpadding="5" cellspacing="0" >
			...
			<tr>
				<td nowrap="nowrap"><input type="text" id="totalIncome" name="totalIncome" value="${pay.totalIncome}" class="required number"  title="请输入有效的金额" readonly="readonly"></td>
				<td><input type="text" id="groupCost" name="groupCost" value="${pay.groupCost}" onkeyup="getSum();" readonly="readonly" class="required number"  title="请输入有效的金额"></td>
				...
				<td colspan="2"><input type="text" id="total" name="total" value="${pay.total}" class="required number" readonly="readonly"></td>
			</tr>
			<tr>
				<td class="titleTd">备注</td>
				<td colspan="5"><input type="text" id="pmemo" name="pmemo" value="${pay.memo}" readonly="readonly"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="titleTd" width="17%" colspan="2">备注</td>
			</tr>
		</table>
		...
		<table id="tb" cellpadding="5" cellspacing="0" style="margin: 0px;width: 100%">
			...
			<tr>
				...
				<td width="17%" ><input type="text" name="dutylevel" value="${payDetail.dutylevel}" readonly="readonly"></td>
				<td width="17%" colspan="2"><input type="text" name="memo" value="${payDetail.memo}" readonly="readonly"></td>
			</tr>
			</c:forEach>
		</table> 
		</div>
