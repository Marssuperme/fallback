				...
				<tbody>
					...
					<tr>
						...
						<td class="data_tb_content" width="30%" height="18">
							<span id="name3">${userMap.loginname }</span>
						</td>
						<td class="data_tb_alignright" width="50%" style="text-align: center" colspan="2" rowspan="4" height="111">
...
function saveAssesser(){
	...
	document.thisForm.action = "${pageContext.request.contextPath}/assesser/assesser.do?method=updateSave";
...
function upLoadSumbit() {
	...
	if(fileName.indexOf(".") > -1) { 
		...
		if(photo == "jpg" || photo == "JPG"){
			...
			myForm.action = "${pageContext.request.contextPath}/assesser/assesser.do?method=uploadPhoto" ;
			hiddenProDiv();
			return true;
		}else{
			alert("只允许上传jpg格式照片!");
